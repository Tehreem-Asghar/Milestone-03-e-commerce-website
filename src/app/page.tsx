          ...
          <div className="flex flex-col justify-center items-center absolute inset-0 font-serif px-4  bg-opacity-40 sm:bg-transparent  sm:text-[#2C2F24] ">
            ...
            <div className="flex gap-4 mt-4">
              ...
              <Button asChild variant="outline" className="rounded-full  border-black text-black">
                <Link href="/menue">Explor Menu </Link>
              </Button>
            </div>
          </div>
        ...
        <section> 
         ...
         <section className="flex flex-col md:flex-row w-full px-7 mt-14 ">
          ...
          <div className=" md:w-1/2 pl-7  w-full">
                ...
                <h3 className="flex gap-4 mb-5 mt-4 text-[#2C2F24] font-bold"><span className="bg-[#AD343E] text-white p-2 rounded-full w-auto h-8 "> <MdOutlineWatchLater /></span> Delivery within 30 minutes</h3>
                <h3 className="flex gap-4 mb-5 text-[#2C2F24] font-bold "><span className="bg-[#AD343E] text-white p-2 rounded-full  w-auto h-8"> <IoPricetagsOutline /></span> Best Offer & Prices</h3>
                <h3 className="flex gap-4 mb-5 text-[#2C2F24] font-bold"> <span className="bg-[#AD343E] text-white p-2 rounded-full w-auto h-8"><MdOutlineShoppingCart /> </span> Online Services Available</h3>
          </div>
         </section>
         {/* comments */}
         <section>
