...
export default function about() {
  ...
  <div className="lg:w-1/2 w-full px-4 flex justify-start sm:h-[350px] h-[250px]">
    <Image
      src="/image/about/about1.png"
      height={556}
      width={599}
      alt="healthy food"
      className="sm:h-[350px] h-[250px] w-full object-cover shadow-lg"
    />
  </div>
  <div className="lg:w-1/2 w-full mt-4 md:pr-9 h-auto md:pl-9 p-2">
    ...
    <p className="mt-3 font-sans text-[#2C2F24]">
    ...
    <p className="mt-3 font-sans text-[#414536]">
      At place, we believe that dining is not just about food, but also about the overall experience. Our staff, renowned for their warmth and dedication, strives to make every visit an unforgettable event.
            ...
            <section className="h-auto w-full px-3 mt-10 flex flex-col items-center justify-center ">
                <h2 className="text-3xl font-bold font-serif mb-7  text-[#AD343E]">Feel the authentic & original taste from us</h2>
            ...
            {/* little Information */}
             ...
             {/* comments */}
         <section>
          <h2 className="text-3xl font-serif font-medium text-center mt-12 my-7">What Our Customers Say</h2>
          <Comments/>
         </section>
        </main>
    )
