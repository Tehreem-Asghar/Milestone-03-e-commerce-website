    ...
    return (
        <main className="w-full h-auto">
            <section className=" w-full h-auto py-6  flex  flex-col ">
                ...
                <p className=" mt-4 px-9 text-center  text-[#495460]">We consider all the drivers of change gives you the components  you need to change to create a truly happens.</p>
            </section>
