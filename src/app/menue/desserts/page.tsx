...
export default async function desserts() {
  const req = await fetch(`https://milestone-03-e-commerce-website.vercel.app/api/desserts`,{cache : "no-store"});
        ...
        {res.map((menue: Menue) => (
          ...
          >
              ...
              <section>
                <Dialog>
                  <DialogTrigger asChild>
                    <Button
                      variant="outline"
                      className="absolute top-2 h-8 w-8 left-2 hover:bg-[#AD343E] hover:text-white bg-[#AD343E] opacity-90 font-bold hover:opacity-70 text-white text-5xl p-2 rounded-full"
                    >
                      <MdAddShoppingCart />
                    </Button>
                  </DialogTrigger>
                  <DialogContent className="sm:max-w-[425px]  w-[90%]">
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      <div className="w-full">
                        ...
                        <h2 className="text-xl text-center  text-[#AD343E] font-bold">{`Price : $ ${menue.price}`}</h2>
                      </div>
                    </div>
            ...
            <div className="w-full h-36 mt-4 flex flex-col justify-center items-center">
              <h3 className="text-2xl text-[#AD343E]">${menue.price}</h3>
