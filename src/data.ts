...
export const dishes :Menue[]= [
    {
        ...
        'description': 'Our Hawaiian Pizza is a delightful mix of tropical and classic flavors. Featuring juicy pineapple chunks, savory ham slices, and a generous layer of melted mozzarella cheese, all atop a crispy golden crust. Topped with a tangy tomato sauce, it’s a flavorful escape to paradise with every bite!'
    },
    {
        'id': 10,
        'name': 'Cheese Burger',
    ...
    },
    {
        ...
        "image": "/image/dishes/biryani.png",
        "description": "Our Chicken Biryani is a delightful combination of fragrant basmati rice, succulent chicken, and a blend of traditional spices. Each spoonful bursts with flavors, featuring tender chicken pieces cooked to perfection and mixed with perfectly seasoned rice. Served with raita and salad, this dish is a must-try for biryani enthusiasts!"
    },
    {
        "id": 12,
        "name": "Tikka Boti",
...
export const drink: Menue[] = [
    ...
    
    {
        ...
        "image": "/image/drinks/Kesar-pista-icecream.png",
